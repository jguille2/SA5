/*
  SA5Firmata_ir version 6 (is the "ir" version, supporting IR features but with a blocking tone function)
  Pins 2 (v2), 5 (v5/6 tone and ir), 6 (v5/6 ir) and 3 (v6 supporting neopixels) are marked as SHIFT mode
    ...
    case CAPABILITY_QUERY:
      ...
      for (byte pin = 0; pin < TOTAL_PINS; pin++) {
        if (IS_PIN_DIGITAL(pin)) {
          ...
          Firmata.write(1);
//////////////////////////////////////////////////
//SA5_ir version 6. Marking digital pins 2, 3, 5 and 6
      if (pin == 2 || pin == 3 || pin == 5 || pin == 6) {
...
//
// Ending 18 sysex commands for SA5Firmata_ir 
//////////////////////////////////////////////////
